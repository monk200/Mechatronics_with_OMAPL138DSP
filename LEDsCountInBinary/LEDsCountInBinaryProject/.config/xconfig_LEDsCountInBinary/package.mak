...
override PKGDIR = xconfig_Lab1_Part3
...
package/%.xdc.inc package/%_xconfig_Lab1_Part3.c package/%.defs.h: %.xdc $(PKGCFGS)
	@$(MSG) generating interfaces for package xconfig_Lab1_Part3" (because $@ is older than $(firstword $?))" ...
	$(XSRUN) -f xdc/services/intern/cmd/build.xs $(MK_IDLOPTS) -m package/package.xdc.dep -i package/package.xdc.inc package.xdc

.dlls,e674 .dlls: Lab1_Part3.pe674

-include package/cfg/Lab1_Part3_pe674.mak
-include package/cfg/Lab1_Part3_pe674.cfg.mak
ifeq (,$(MK_NOGENDEPS))
-include package/cfg/Lab1_Part3_pe674.dep
endif
Lab1_Part3.pe674: package/cfg/Lab1_Part3_pe674.xdl
	@


ifeq (,$(wildcard .libraries,e674))
Lab1_Part3.pe674 package/cfg/Lab1_Part3_pe674.c: .libraries,e674
endif

package/cfg/Lab1_Part3_pe674.c package/cfg/Lab1_Part3_pe674.h package/cfg/Lab1_Part3_pe674.xdl: override _PROG_NAME := Lab1_Part3.xe674
package/cfg/Lab1_Part3_pe674.c: package/cfg/Lab1_Part3_pe674.cfg
package/cfg/Lab1_Part3_pe674.xdc.inc: package/cfg/Lab1_Part3_pe674.xdl
package/cfg/Lab1_Part3_pe674.xdl package/cfg/Lab1_Part3_pe674.c: .interfaces

clean:: clean,e674
	-$(RM) package/cfg/Lab1_Part3_pe674.cfg
	-$(RM) package/cfg/Lab1_Part3_pe674.dep
	-$(RM) package/cfg/Lab1_Part3_pe674.c
	-$(RM) package/cfg/Lab1_Part3_pe674.xdc.inc

clean,e674::
	-$(RM) Lab1_Part3.pe674
.executables,e674 .executables: Lab1_Part3.xe674

Lab1_Part3.xe674: |Lab1_Part3.pe674

-include package/cfg/Lab1_Part3.xe674.mak
Lab1_Part3.xe674: package/cfg/Lab1_Part3_pe674.oe674 
	$(RM) $@
	@$(MSG) lnke674 $@ ...
	$(RM) $(XDCCFGDIR)/$@.map
	$(ti.targets.elf.C674.rootDir)/bin/cl6x -fs $(XDCCFGDIR)$(dir $@). -q -u _c_int00 --abi=eabi -z  -o $@ package/cfg/Lab1_Part3_pe674.oe674   package/cfg/Lab1_Part3_pe674.xdl  -w -c -m $(XDCCFGDIR)/$@.map -l $(ti.targets.elf.C674.rootDir)/lib/libc.a
	
Lab1_Part3.xe674: export C_DIR=
Lab1_Part3.xe674: PATH:=$(ti.targets.elf.C674.rootDir)/bin/;$(PATH)
Lab1_Part3.xe674: Path:=$(ti.targets.elf.C674.rootDir)/bin/;$(PATH)

Lab1_Part3.test test,e674 test: Lab1_Part3.xe674.test

Lab1_Part3.xe674.test:: Lab1_Part3.xe674
ifeq (,$(_TESTLEVEL))
	@$(MAKE) -R -r --no-print-directory -f $(XDCROOT)/packages/xdc/bld/xdc.mak _TESTLEVEL=1 Lab1_Part3.xe674.test
else
	@$(MSG) running $<  ...
	$(call EXEC.Lab1_Part3.xe674, ) 
endif

clean,e674::
	-$(RM) $(wildcard .tmp,Lab1_Part3.xe674,*)
...
%,copy:
	...
	$(RM) $@
	$(CP) $< $@
Lab1_Part3_pe674.oe674,copy : package/cfg/Lab1_Part3_pe674.oe674
Lab1_Part3_pe674.se674,copy : package/cfg/Lab1_Part3_pe674.se674

$(XDCCFGDIR)%.c $(XDCCFGDIR)%.h $(XDCCFGDIR)%.xdl: $(XDCCFGDIR)%.cfg $(XDCROOT)/packages/xdc/cfg/Main.xs | .interfaces
	@$(MSG) "configuring $(_PROG_NAME) from $< ..."
	$(CONFIG) $(_PROG_XSOPTS) xdc.cfg $(_PROG_NAME) $(XDCCFGDIR)$*.cfg $(XDCCFGDIR)$*

.PHONY: release,xconfig_Lab1_Part3
ifeq (,$(MK_NOGENDEPS))
-include package/rel/xconfig_Lab1_Part3.tar.dep
endif
package/rel/xconfig_Lab1_Part3/xconfig_Lab1_Part3/package/package.rel.xml: package/package.bld.xml
package/rel/xconfig_Lab1_Part3/xconfig_Lab1_Part3/package/package.rel.xml: package/build.cfg
package/rel/xconfig_Lab1_Part3/xconfig_Lab1_Part3/package/package.rel.xml: package/package.xdc.inc
package/rel/xconfig_Lab1_Part3/xconfig_Lab1_Part3/package/package.rel.xml: .force
	@$(MSG) generating external release references $@ ...
	$(XS) $(JSENV) -f $(XDCROOT)/packages/xdc/bld/rel.js $(MK_RELOPTS) . $@

xconfig_Lab1_Part3.tar: package/rel/xconfig_Lab1_Part3.xdc.inc package/rel/xconfig_Lab1_Part3/xconfig_Lab1_Part3/package/package.rel.xml
	@$(MSG) making release file $@ "(because of $(firstword $?))" ...
	-$(RM) $@
	$(call MKRELTAR,package/rel/xconfig_Lab1_Part3.xdc.inc,package/rel/xconfig_Lab1_Part3.tar.dep)


release release,xconfig_Lab1_Part3: all xconfig_Lab1_Part3.tar
clean:: .clean
	-$(RM) xconfig_Lab1_Part3.tar
	-$(RM) package/rel/xconfig_Lab1_Part3.xdc.inc
	-$(RM) package/rel/xconfig_Lab1_Part3.tar.dep
