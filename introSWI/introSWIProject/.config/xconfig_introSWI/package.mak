...
override PKGDIR = xconfig_Lab2_Part4
...
package/%.xdc.inc package/%_xconfig_Lab2_Part4.c package/%.defs.h: %.xdc $(PKGCFGS)
	@$(MSG) generating interfaces for package xconfig_Lab2_Part4" (because $@ is older than $(firstword $?))" ...
	$(XSRUN) -f xdc/services/intern/cmd/build.xs $(MK_IDLOPTS) -m package/package.xdc.dep -i package/package.xdc.inc package.xdc

.dlls,e674 .dlls: Lab2_Part4.pe674

-include package/cfg/Lab2_Part4_pe674.mak
-include package/cfg/Lab2_Part4_pe674.cfg.mak
ifeq (,$(MK_NOGENDEPS))
-include package/cfg/Lab2_Part4_pe674.dep
endif
Lab2_Part4.pe674: package/cfg/Lab2_Part4_pe674.xdl
	@


ifeq (,$(wildcard .libraries,e674))
Lab2_Part4.pe674 package/cfg/Lab2_Part4_pe674.c: .libraries,e674
endif

package/cfg/Lab2_Part4_pe674.c package/cfg/Lab2_Part4_pe674.h package/cfg/Lab2_Part4_pe674.xdl: override _PROG_NAME := Lab2_Part4.xe674
package/cfg/Lab2_Part4_pe674.c: package/cfg/Lab2_Part4_pe674.cfg
package/cfg/Lab2_Part4_pe674.xdc.inc: package/cfg/Lab2_Part4_pe674.xdl
package/cfg/Lab2_Part4_pe674.xdl package/cfg/Lab2_Part4_pe674.c: .interfaces

clean:: clean,e674
	-$(RM) package/cfg/Lab2_Part4_pe674.cfg
	-$(RM) package/cfg/Lab2_Part4_pe674.dep
	-$(RM) package/cfg/Lab2_Part4_pe674.c
	-$(RM) package/cfg/Lab2_Part4_pe674.xdc.inc

clean,e674::
	-$(RM) Lab2_Part4.pe674
.executables,e674 .executables: Lab2_Part4.xe674

Lab2_Part4.xe674: |Lab2_Part4.pe674

-include package/cfg/Lab2_Part4.xe674.mak
Lab2_Part4.xe674: package/cfg/Lab2_Part4_pe674.oe674 
	$(RM) $@
	@$(MSG) lnke674 $@ ...
	$(RM) $(XDCCFGDIR)/$@.map
	$(ti.targets.elf.C674.rootDir)/bin/cl6x -fs $(XDCCFGDIR)$(dir $@). -q -u _c_int00 --abi=eabi -z  -o $@ package/cfg/Lab2_Part4_pe674.oe674   package/cfg/Lab2_Part4_pe674.xdl  -w -c -m $(XDCCFGDIR)/$@.map -l $(ti.targets.elf.C674.rootDir)/lib/libc.a
	
Lab2_Part4.xe674: export C_DIR=
Lab2_Part4.xe674: PATH:=$(ti.targets.elf.C674.rootDir)/bin/;$(PATH)
Lab2_Part4.xe674: Path:=$(ti.targets.elf.C674.rootDir)/bin/;$(PATH)

Lab2_Part4.test test,e674 test: Lab2_Part4.xe674.test

Lab2_Part4.xe674.test:: Lab2_Part4.xe674
ifeq (,$(_TESTLEVEL))
	@$(MAKE) -R -r --no-print-directory -f $(XDCROOT)/packages/xdc/bld/xdc.mak _TESTLEVEL=1 Lab2_Part4.xe674.test
else
	@$(MSG) running $<  ...
	$(call EXEC.Lab2_Part4.xe674, ) 
endif

clean,e674::
	-$(RM) $(wildcard .tmp,Lab2_Part4.xe674,*)
...
%,copy:
	...
	$(RM) $@
	$(CP) $< $@
Lab2_Part4_pe674.oe674,copy : package/cfg/Lab2_Part4_pe674.oe674
Lab2_Part4_pe674.se674,copy : package/cfg/Lab2_Part4_pe674.se674

$(XDCCFGDIR)%.c $(XDCCFGDIR)%.h $(XDCCFGDIR)%.xdl: $(XDCCFGDIR)%.cfg $(XDCROOT)/packages/xdc/cfg/Main.xs | .interfaces
	@$(MSG) "configuring $(_PROG_NAME) from $< ..."
	$(CONFIG) $(_PROG_XSOPTS) xdc.cfg $(_PROG_NAME) $(XDCCFGDIR)$*.cfg $(XDCCFGDIR)$*

.PHONY: release,xconfig_Lab2_Part4
ifeq (,$(MK_NOGENDEPS))
-include package/rel/xconfig_Lab2_Part4.tar.dep
endif
package/rel/xconfig_Lab2_Part4/xconfig_Lab2_Part4/package/package.rel.xml: package/package.bld.xml
package/rel/xconfig_Lab2_Part4/xconfig_Lab2_Part4/package/package.rel.xml: package/build.cfg
package/rel/xconfig_Lab2_Part4/xconfig_Lab2_Part4/package/package.rel.xml: package/package.xdc.inc
package/rel/xconfig_Lab2_Part4/xconfig_Lab2_Part4/package/package.rel.xml: .force
	@$(MSG) generating external release references $@ ...
	$(XS) $(JSENV) -f $(XDCROOT)/packages/xdc/bld/rel.js $(MK_RELOPTS) . $@

xconfig_Lab2_Part4.tar: package/rel/xconfig_Lab2_Part4.xdc.inc package/rel/xconfig_Lab2_Part4/xconfig_Lab2_Part4/package/package.rel.xml
	@$(MSG) making release file $@ "(because of $(firstword $?))" ...
	-$(RM) $@
	$(call MKRELTAR,package/rel/xconfig_Lab2_Part4.xdc.inc,package/rel/xconfig_Lab2_Part4.tar.dep)


release release,xconfig_Lab2_Part4: all xconfig_Lab2_Part4.tar
clean:: .clean
	-$(RM) xconfig_Lab2_Part4.tar
	-$(RM) package/rel/xconfig_Lab2_Part4.xdc.inc
	-$(RM) package/rel/xconfig_Lab2_Part4.tar.dep
