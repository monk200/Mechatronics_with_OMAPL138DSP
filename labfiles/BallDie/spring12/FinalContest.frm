...
Begin VB.Form Form1 
   ...
   Begin VB.CommandButton drawButton 
      ...
      Width           =   1692
   End
   Begin VB.Label lblscoreLost 
      Caption         =   "Found Way Back = -0 seconds"
      BeginProperty Font 
         Name            =   "MS Sans Serif"
         Size            =   9.6
         Charset         =   0
   ...
   Begin VB.Label Label5 
      Alignment       =   2  'Center
      BackStyle       =   0  'Transparent
      Caption         =   "Robot Found its way back to orange circle"
      BeginProperty Font 
         Name            =   "MS Sans Serif"
         Size            =   9.6
         Charset         =   0
...
For N = 0 To 4 'outer loop to try to attach each ball
    ...
    ScoreTotal = TimerTime + scoreBallLoc + scoreCanAccr + scoreBallDrop + scoreLost
