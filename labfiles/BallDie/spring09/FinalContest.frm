...
Dim scoreBallLoc, scoreCanAccr, scoreBallDrop As Integer
...
For N = 0 To 4 'outer loop to try to attach each ball
    ...
    For I = 0 To 4
        ...
        End If
    Next
    scoreCanAccr = -20 * (3 - VScrollBlue.Value + 3 - VScrollOrange.Value)
    scoreBallDrop = Abs(HScrollCanAccr.Value) * 20
    lblScoreLocation = "Location = " + CStr(scoreBallLoc) + " seconds"
    lblScoreBallDrop = "BallDrop = " + CStr(scoreCanAccr) + " seconds"
    lblScoreCanAccr = "CanAccr = " + CStr(scoreBallDrop) + " seconds"
