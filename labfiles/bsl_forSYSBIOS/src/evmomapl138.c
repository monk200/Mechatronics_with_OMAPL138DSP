...
uint32_t EVMOMAPL138_initRAM(void)
{
   ...
   // enable emif3a clock.
   EVMOMAPL138_lpscTransition(PSC1, DOMAIN0, LPSC_DDR2, PSC_ENABLE);
   ...
   EVMOMAPL138_lpscTransition(PSC1, DOMAIN0, LPSC_DDR2, PSC_SYNCRESET);
...
void EVMOMAPL138_pinmuxConfig(uint32_t in_reg, uint32_t in_mask, uint32_t in_val)
{
  ...
  #warn Commented out KICK0R_LOCK and KICK1R_LOCK calls
  // Dan Block commented out to avoid conflicts with Linux 
...
//   EVMOMAPL138_lpscTransition(PSC1, DOMAIN0, LPSC_SATA, PSC_ENABLE);
   ...
   EVMOMAPL138_lpscTransition(PSC1, DOMAIN0, LPSC_uPP, PSC_ENABLE);
...
// Dan Block add these
   EVMOMAPL138_lpscTransition(PSC1, DOMAIN0, LPSC_SCRF0, PSC_ENABLE);
   EVMOMAPL138_lpscTransition(PSC1, DOMAIN0, LPSC_SCRF1, PSC_ENABLE);
   EVMOMAPL138_lpscTransition(PSC1, DOMAIN0, LPSC_SCRF2, PSC_ENABLE);         
   EVMOMAPL138_lpscTransition(PSC1, DOMAIN0, LPSC_SCRF6, PSC_ENABLE);
   EVMOMAPL138_lpscTransition(PSC1, DOMAIN0, LPSC_SCRF7, PSC_ENABLE);
   EVMOMAPL138_lpscTransition(PSC1, DOMAIN0, LPSC_SCRF8, PSC_ENABLE);         
   EVMOMAPL138_lpscTransition(PSC1, DOMAIN0, LPSC_BRDGF7, PSC_ENABLE);   
//#warn from the data sheet it looks like SHRAM is in DOMAIN1 so I changed to DOMAIN1
//    EVMOMAPL138_lpscTransition(PSC1, DOMAIN0, LPSC_SHRAM, PSC_ENABLE);
    EVMOMAPL138_lpscTransition(PSC1, DOMAIN1, LPSC_SHRAM, PSC_ENABLE);   
   return (ERR_NO_ERROR);
}
