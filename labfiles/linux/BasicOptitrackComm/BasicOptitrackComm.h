#ifndef BASICOPTITRACKCOMM_H
#define BASICOPTITRACKCOMM_H
#include <stdio.h>
#include <signal.h>
#include <pthread.h>
#include "netapi.h"
...
// Dan Block changed from 12345 to 10001, Rick changed to 3500
...
//***************************************************************************//
int packet_size;    //To be defined at the command line
int num_agents;
//***************************************************************************//
...
typedef struct udp_con {
  ...
  int in_pkt_sent;                   // last serial-sent pkt ind44ex
