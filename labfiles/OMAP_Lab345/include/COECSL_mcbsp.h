...
void SetRobotOutputs(float vref, float turn, float pwm3, float pwm4, float servo1, float servo2, float servo3, float servo4, float dac1, float dac2);
void SetRobotOutputs_manual(float pwm1, float pwm2, float pwm3, float pwm4, float servo1, float servo2, float servo3, float servo4, float dac1, float dac2);
