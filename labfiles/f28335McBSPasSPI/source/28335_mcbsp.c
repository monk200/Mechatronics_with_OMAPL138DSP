...
unsigned long dannum_intCH1 = 0;
unsigned long dannum_intCH2 = 0;
...
//			if (((*(unsigned long *)(&RXBuff.data.turn)) & 0xFF800000) != 0xFF800000) mcbsp_turn = RXBuff.data.turn;
			if (((*(unsigned long *)(&RXBuff.data.PWM[0])) & 0xFF800000) != 0xFF800000) PWM_out(EPWM1,RXBuff.data.PWM[0]);
			if (((*(unsigned long *)(&RXBuff.data.PWM[1])) & 0xFF800000) != 0xFF800000) PWM_out(EPWM2,RXBuff.data.PWM[1]);
			...
			if (((*(unsigned long *)(&RXBuff.data.DAC[0])) & 0xFF800000) != 0xFF800000) mcbsp_dac1 = RXBuff.data.DAC[2];
			if (((*(unsigned long *)(&RXBuff.data.DAC[1])) & 0xFF800000) != 0xFF800000) mcbsp_dac2 = RXBuff.data.DAC[3];
