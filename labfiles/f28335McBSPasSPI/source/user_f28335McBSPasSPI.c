...
//    InitPll(PLL,2);
    ...
    EALLOW;  // Not using McBSPB CLKR so set GPIO60 to Output for HWI pulse to BBX15 DSP
...
//    if (McBSPB_rdy == 1) {
//    RYAN new data structure
        TXBuff.data.garbage = 0xDEAD;
        TXBuff.data.validcode = VALID_28XTO67X;
        TXBuff.data.flags++;// = 0xAADDAADD;  // Dan New
...
//        TXBuff.data.compass = (float)CompassNew;
        ...
        TXBuff.data.ADC[0] = (float)raw_adc_B0;
        TXBuff.data.ADC[1] = (float)raw_adc_B1;
        TXBuff.data.ADC[2] = (float)raw_adc_A2;
        TXBuff.data.ADC[3] = (float)raw_adc_B2;
        TXBuff.data.ADC[4] = (float)raw_adc_A3;
        TXBuff.data.ADC[5] = (float)raw_adc_B3;
        TXBuff.data.ADC[6] = (float)raw_adc_A4;
        TXBuff.data.ADC[7] = (float)raw_adc_B4;
        TXBuff.data.ADC[8] = (float)raw_adc_A5;
        TXBuff.data.ADC[9] = (float)raw_adc_B5;
//        TXBuff.darray[0] = 1;
//        TXBuff.darray[1] = 2;
//        TXBuff.darray[2] = 3;
//        TXBuff.darray[3] = 4;
