...
NoError:
        ...
        PrintLine(1, "copy " & ProjectDirectory & "..\..\LabFiles\Sp2019OMAPL138ProjCreatorFiles\SYSBIOS\PROJECTNAME.cfg " & Project_SYSBIOS_Dir & ProjectName & ".cfg")
        PrintLine(1, "copy " & ProjectDirectory & "..\..\LabFiles\Sp2019OMAPL138ProjCreatorFiles\include\*.* " & Project_include_Dir)
        PrintLine(1, "copy " & ProjectDirectory & "..\..\LabFiles\Sp2019OMAPL138ProjCreatorFiles\PRUcode\*.* " & Project_PRUcode_Dir)
        PrintLine(1, "copy " & ProjectDirectory & "..\..\LabFiles\Sp2019OMAPL138ProjCreatorFiles\source\*.* " & Project_source_Dir)
        PrintLine(1, "move " & Project_source_Dir & "user_PROJECTNAME.c " & Project_source_Dir & "user_" & ProjectName & ".c")
        PrintLine(1, "copy " & ProjectDirectory & "..\..\LabFiles\Sp2019OMAPL138ProjCreatorFiles\project\*.ccxml " & ProjectSubDirectory)
        PrintLine(1, "copy " & ProjectDirectory & "..\..\LabFiles\Sp2019OMAPL138ProjCreatorFiles\project\.settings\*.* " & ProjectSub_settings_Dir)
        PrintLine(1, "copy " & ProjectDirectory & "..\..\LabFiles\Sp2019OMAPL138ProjCreatorFiles\project\.launches\*.* " & ProjectSub_launches_Dir)
        PrintLine(1, "copy " & ProjectDirectory & "..\..\LabFiles\Sp2019OMAPL138ProjCreatorFiles\project\targetConfigs\*.* " & ProjectSub_targetConfigs_Dir)
        PrintLine(1, Drive)
