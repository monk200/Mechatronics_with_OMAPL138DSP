function varargout = Matlab_SendFloatsV2(varargin)
% Matlab_SendFloatsV2 MATLAB code for Matlab_SendFloatsV2.fig
%      
...
% Edit the above text to modify the response to help Matlab_SendFloatsV2

% Last Modified by GUIDE v2.5 06-May-2014 13:00:03

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @Matlab_SendFloatsV2_OpeningFcn, ...
                   'gui_OutputFcn',  @Matlab_SendFloatsV2_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before Matlab_SendFloatsV2 is made visible.
function Matlab_SendFloatsV2_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to Matlab_SendFloatsV2 (see VARARGIN)
...
% Choose default command line output for Matlab_SendFloatsV2
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes Matlab_SendFloatsV2 wait for user response (see UIRESUME)
% uiwait(handles.figure1);

% --- Outputs from this function are returned to the command line.
function varargout = Matlab_SendFloatsV2_OutputFcn(hObject, eventdata, handles) 
...
if(~isempty(handles.TCPIP.mySocket))
    ...
    if(wrapperCreated)
        try
            ...
            set(handles.TCPIP.writeOutTimer,'TimerFcn',{'writeOutDataV2',hObject,handles},'Period',0.1)
...
if(~isempty(handles.TCPIP.mySocket))
    ...
    set(handles.TCPIP.writeOutTimer,'TimerFcn',{'writeOutDataV2',hObject,handles})
    start(handles.TCPIP.writeOutTimer)
end
