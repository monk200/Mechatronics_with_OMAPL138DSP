function varargout = Matlab_SendFloats(varargin)
% Matlab_SendFloats MATLAB code for Matlab_SendFloats.fig
%      
...
% Edit the above text to modify the response to help Matlab_SendFloats

% Last Modified by GUIDE v2.5 24-Apr-2014 11:45:56

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @Matlab_SendFloats_OpeningFcn, ...
                   'gui_OutputFcn',  @Matlab_SendFloats_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before Matlab_SendFloats is made visible.
function Matlab_SendFloats_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to Matlab_SendFloats (see VARARGIN)
...
% Choose default command line output for Matlab_SendFloats
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes Matlab_SendFloats wait for user response (see UIRESUME)
% uiwait(handles.figure1);

% --- Outputs from this function are returned to the command line.
function varargout = Matlab_SendFloats_OutputFcn(hObject, eventdata, handles) 
...
if(~isempty(handles.TCPIP.mySocket))
    ...
    if(wrapperCreated)
        try
            ...
            set(handles.TCPIP.writeOutTimer,'TimerFcn',{'writeOutData',hObject,handles},'Period',0.1)
