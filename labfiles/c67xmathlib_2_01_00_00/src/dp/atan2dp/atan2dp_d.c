...
void main(){
    ...
    for (i = 0; i < NUM_INPUTS ; i++) {
        a1[i] = atan2dp(a[i], b[i]);
    }
    for (i = 0; i < NUM_INPUTS; i++) {
        a2[i] = atan2dp_c(a[i], b[i]);
    }
	for (i = 0; i < NUM_INPUTS ; i++) {
        a3[i] = atan2dp_i(a[i], b[i]);
    }
    atan2dp_v(a, b, a4, NUM_INPUTS);
    ...
    t_start = clock();
    for (i = 0; i < BUF_SIZE; i++) {
        output1[i] = atan2dp(arg[i], arg1[i]);
    }
    t_stop = clock();
    ...
    t_start = clock();
    for (i = 0; i < BUF_SIZE; i++) {
        output2[i] = atan2dp_c(arg[i], arg1[i]);
    }
    t_stop = clock();
    ...
    t_start = clock();  
    for (i = 0; i < BUF_SIZE; i++) {
        output3[i] = atan2dp_i(arg[i], arg1[i]);
    }
    t_stop = clock();
    ...
    t_start = clock();  
    atan2dp_v(arg, arg1, output4, BUF_SIZE);
    t_stop = clock();
    ...
    // Didplay Test Vector Verificaition Results 
    ...
    // Didplay Random Test Vector Results   
    ...
    // Didplay average clock for RTS, ASM, Inlined and Vector methods
    printf ("\n");
