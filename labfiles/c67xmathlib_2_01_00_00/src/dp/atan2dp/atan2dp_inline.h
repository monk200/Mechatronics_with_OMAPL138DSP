/* =========================================================================== */
/* atan2dp_inline.h - double precision floating point arctangent two arguement */
...
#ifndef ATAN2DP_INLINE_
#define ATAN2DP_INLINE_ 1
...
static inline double atan2dp_inline(double a, double b)
{
