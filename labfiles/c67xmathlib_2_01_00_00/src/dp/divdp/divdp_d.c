...
void main(){
    ...
    for (i = 0; i < NUM_INPUTS; i++) {
        a2[i] = divdp_c(a[i], b[i]);
    }
	for (i = 0; i < NUM_INPUTS ; i++) {
        a3[i] = divdp_i(a[i], b[i]);
    }
    divdp_v(a, b, a4, NUM_INPUTS);
    ...
    t_start = clock();
    for (i = 0; i < BUF_SIZE; i++) {
        output2[i] = divdp_c(arg[i], arg1[i]);
    }
    t_stop = clock();
    ...
    t_start = clock();  
    for (i = 0; i < BUF_SIZE; i++) {
        output3[i] = divdp_i(arg[i], arg1[i]);
    }
    t_stop = clock();
    ...
    t_start = clock();  
    divdp_v(arg, arg1, output4, BUF_SIZE);
    t_stop = clock();
