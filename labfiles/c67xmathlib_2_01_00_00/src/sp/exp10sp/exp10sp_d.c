...
//  Initialized arrays with fixed test data.float a [NUM_INPUTS] = 
...
void main(){
    ...
    t_start = clock();  
    exp10sp_v(arg, output4, BUF_SIZE);
    t_stop = clock();
    ...
    printf ("\n");
    printf ("Number of Clocks for exp10:\n");
    printf ("-------------------------------------------------------------------------------------------------------\n");
