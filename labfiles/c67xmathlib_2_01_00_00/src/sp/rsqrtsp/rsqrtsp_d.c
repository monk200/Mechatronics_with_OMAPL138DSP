...
void main(){
    ...
    t_start = clock();  
    rsqrtsp_v(arg, output4, BUF_SIZE);
    t_stop = clock();
    ...
    printf ("\n");
    printf ("Number of Clocks for rsqrt:\n");
    printf ("-------------------------------------------------------------------------------------------------------\n");
