...
void main(){
    ...
    t_start = clock();  
    recipsp_v(arg, output4, BUF_SIZE);
    t_stop = clock();
    ...
    printf ("\n");
    printf ("Number of Clocks for recip:\n");
    printf ("-------------------------------------------------------------------------------------------------------\n");
