...
void main(){
    ...
    printf ("\n");
    printf ("Number of Clocks for exp:\n");
    printf ("-------------------------------------------------------------------------------------------------------\n");
...
int isequal(float *arg1, float *arg2, int size, double tol){
	...
	int flag = 1;	
		for (x = 0; x < size; x++) {
			if((fabs(arg1[x] - arg2[x])/arg1[x] > tol*100) && (arg1[x]!=0)){
				flag = 0;
				break;
			}
		}
