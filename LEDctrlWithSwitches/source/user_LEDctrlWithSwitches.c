...
void checkswitches (void) {
    if (GETSWITCH1 == 0) SETLED1;       // SWITCH1 is pressed -> turn on LED1
    if (GETSWITCH1 == 1) CLRLED1;       // SWITCH1 is not pressed -> turn off LED1
    if (GETSWITCH2 == 0) SETLED2;       // SWITCH2 is pressed -> turn on LED2
    if (GETSWITCH2 == 1) CLRLED2;       // SWITCH2 is not pressed -> turn off LED2
}
